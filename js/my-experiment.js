...
const learning_block_1 = { timeline: [learning_procedure], timeline_variables: learning_stimuli_part1, randomize_order: false };
const learning_block_2 = { timeline: [learning_procedure], timeline_variables: learning_stimuli_part2, randomize_order: false };
    ...
    if(chunk.length > 0){
        timeline.push({
            ...
            message: `<div style="text-align:center;">
                <p>実験データを準備しています...</p>
                <p>音声の読み込み中 (${index + 1}/${sound_chunks.length})</p>
                ...
                <p style="font-size: 14px; color: #555; margin-top: 30px;">
                    読み込みに時間がかかる場合があります。<br>
                    もしロードが止まったりエラーが出た場合は、ページを再読み込みしてください。<br>
                    (The experiment failed to load. Please reload the page.)
                </p>
            </div>`,
            max_load_time: 60000, 
